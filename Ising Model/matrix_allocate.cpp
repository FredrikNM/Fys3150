...
std::random_device rdev;      // Random device
std::mt19937_64 randng(rdev());  // Choosing generator
std::uniform_real_distribution<double> u_cont_d;  // Setting up a uniform continuous distribution
